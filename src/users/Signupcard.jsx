    ...
    return(
     ...
     <div className="container">
         <div className="mainbody">
            ...
            <p className="subtitle">Hey👋, this is Amrah. If you don't have an account signup here</p>
            ...
            <div className="inputgroup">
              <h5 className="inputlabel">Confirm Password</h5>
              <input type="text" placeholder="Confirm your Password" className="inputfield"/>
            </div>
            ...
            <div className="signupbtn-container">
             <button className="signupbtn-main">SignUp</button>
            </div>
          </div>
     </div>
        </>
